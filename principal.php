...
if (!isset($_SESSION['user_id'])) {
    echo "<script>alert('Debes iniciar sesión para acceder a esta página.'); window.location.href = 'iniciar.php';</script>";
    exit;
}
include 'db.php';
...
<header>
    <div class="logo-container">
        <img src="imagenes\Logotipo Animado de Equipo de E-Sports en Verde Azulado Negro estilo Alegre Ilustrativo.gif"
            alt="Logo" class="logo">
    </div>
    ...
    <body>
        ...
        <nav>
            <ol>
                ...
                <le>
                    <a href="iniciar.php">
                        <p class="fas fa-sign-in-alt"></p>Iniciar Sesión
                    </a>
                </le>
                <le>
                    <a href="signup.php">
                        <p class="fas fa-user-plus"></p>Registrarse
                    </a>
                </le>
        </nav>
    ...
    <div class="container">
        <div class="d-flex justify-content-between">
            <div class="footer-logo-contact text-center me-3">
                <h3> N.A.E.I Market</h3>
                <img src="imagenes/Logotipo Animado de Equipo de E-Sports en Verde Azulado Negro estilo Alegre Ilustrativo.gif"
                    alt="Logo N.A.E.I Market" class="logo1">
                <path fill="#fff"
                ...
                <div class="contact-info">
                    <p class="contact-title"><strong>¿Tienes alguna pregunta?</strong></p>
                    <div class="contact-item">
                        <i class="fas fa-phone contact-icon"></i>
                        <span>(507) 6551-5025</span>
                    </div>
                    <div class="contact-item">
                        <i class="fas fa-phone contact-icon"></i>
                        <span>(507) 383-7799</span>
                    </div>
                    <div class="contact-item">
                        <i class="fas fa-envelope contact-icon"></i>
                        <span>ventas@Naeimarket.com</span>
                    </div>
                </div>
